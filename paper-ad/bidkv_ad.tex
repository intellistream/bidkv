...
\begin{itemize}
  ...
  \item $T_3$ \textbf{SGLang portability execution (pending).}
    ...
    2 workloads $\times$ 3 arrival rates $\times$ 3 runs (54 total runs).
...
\begin{itemize}
  ...
  \item SGLang portability ($T_3$, pending): mixed and long-context
    workloads, rates $\{2.0, 3.8, 5.7\}$\,req/s and
    $\{0.35, 0.5, 0.7\}$\,req/s respectively,
    3 runs per (strategy, rate) combination (54 total runs).
